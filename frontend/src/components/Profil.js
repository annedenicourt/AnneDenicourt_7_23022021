...
function Profil() {
        ...
        <Banner />
        <div className="row">
        <div className="col-8 col-lg-5 mt-5 mx-auto rounded bg-homepage" >
                <div className='avatar rounded-circle mx-auto p-2 bg-light'><img src={avatar} alt="avatar"/></div>
                <div className='text-center'><label htmlFor="file" className="label-file p-2 mt-4 mb-4">Ajouter/modifier photo</label>
                ...
                <div className="pb-4 pe-4 ps-4">
                        ...
                        <div className="border-bottom text-white mb-2">Service</div>
                        <div className="text-muted mb-4 d-flex justify-content-between align-items-center">Service travaillé<button className='btn btn-light btn-sm'><i className="bi bi-pencil me-1"></i>Modifier</button></div>
